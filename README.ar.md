...
# 🦁 XXD Panel 035｜إعادة بناء المكعبات
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 035 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 035 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 035 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 035 نموذج 8"></td>
  </tr>
</table>

## نماذج 3:4 بتكوين أعلى–أسفل

أربع مصادر أخرى مستقلة، مختلفة عن مجموعة 16:9، بلوحة 3:4 مكتملة: الواقع أعلى والتصميم أسفل، مناصفة دقيقة 50:50. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 035. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 035 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 035 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 035 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 035 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>
...
يناسب **Panel 035** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **يعيد بناء الصورة كقطعة فنية واحدة زاهية من مكعبات فوكسل قابلة للاقتناء**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 035 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 035 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | يعيد بناء الصورة كقطعة فنية واحدة زاهية من مكعبات فوكسل قابلة للاقتناء |
| **السمات التي تُعرف من النظرة الأولى** | موضوع مكعّب واحد · لون حي من المصدر · بلاستيك ABS مطفأ · خلفية هادئة · كتابة معيارية |
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 035. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-035 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-035 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-035 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-035 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-035 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 035 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-035 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
