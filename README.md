...
我做 **Panel 035**，就是想解决这个别扭。它不是给照片硬套模板，而是先认出照片里真正不能丢的东西，再把它翻译成：**把照片重构成一件明艳、可识别的高级像素积木收藏品**。
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 035 样张 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 035 样张 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 035 样张 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 035 样张 8"></td>
  </tr>
</table>
