---
name: xxd-panel-035
description: "Create XXD Panel 035 raster artwork while treating the bundled original style brief as the sole aesthetic authority. Supports one or more top-bottom, left-right, design-only, and four-device wallpaper outputs; multiple ratios or exact sizes; prompt-generated, user-exact, or text-free typography; and inline parameters. Use when the user invokes xxd-panel-035 or requests the exact Panel 035 style."
---
...
```text
/xxd-panel-035 <source> --mode top-bottom,design-only \
